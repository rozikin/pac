        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="<?= base_url('retur/edit'); ?>" method="post" id="form_material">
                        <div class="form-row">
                        <input type="hidden" class="form-control" id="id" name="id" value='<?= $in['id']; ?>'>

                            <div class="col-md-3 mb-1">
                                <label for="kode_retur">kode retur</label>
                                <input type="text" class="form-control form-control-sm" id="kode_retur" name="kode_retur" value="<?= $in['kode_retur']; ?>" placeholder="" required readonly>
                            </div>
